...
<div class="container">
  <div class="inputs">
    ...
    <input type="text" placeholder="username" name='flag'>
...
<?php
    include('conn.php');
    if(isset($_REQUEST['flag'] && isset($_REQUEST['password'])))
    {
        ...
        if($_REQUEST['flag'] == '%' || $_REQUEST['flag'] == '%%')
        {
    	  ...
    	  try{
          $sql = $conn->query('SELECT * from flags where flag = "'.$_REQUEST['flag'].'" and password = "'.$_REQUEST['password'].'";');
          echo ("
          <table border=1>
          <tr>
            <th>flag</th>
